...
import dev.foodcans.pluginutils.PluginUtils;
...
public enum Lang
{
    ...
    HIGH_PING_FORMAT("High-Ping-Format", "&cYou have high ping! ({0}&c)"),
    ...
    HELP("Help", "&8<&9Ping&8> &7Available commands: &f/ping {0}"),
    ...
    LIST_COMMANDS("List-Commands", "&8<&cPing&8> &7To view a list of commands type: &f/ping help"),
    COMMAND_NOT_FOUND("Command-Not-Found",
            "&8<&cPing&8> &7Command not found, to view a list of commands type: &f/ping help"),
